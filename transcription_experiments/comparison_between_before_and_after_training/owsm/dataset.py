...
# Reference: this file is copied (and adjusted) from the Wav2Gloss repository https://github.com/juice500ml/finetune_owsm
...
class FieldworkDataModule(LightningDataModule):
    def __init__(
        ...
        super().__init__()
        self.save_hyperparameters(ignore=["langs", "new_tokens"])
