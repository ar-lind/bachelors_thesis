...
# Reference: this file is copied (and adjusted) from the Wav2Gloss repository https://github.com/juice500ml/espnet/tree/wav2gloss/egs2/wav2gloss/asr1
set -e
set -u
set -o pipefail
...
./asr.sh \
    ...
    --skip_data_prep true \
    --skip_train true \
    --asr_exp "exp/asr_transcription_beja1238_xls_r_conformer"
